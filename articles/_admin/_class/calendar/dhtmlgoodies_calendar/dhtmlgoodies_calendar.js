...
var languageCode = 'ro';	// Possible values: 	en,ge,no,nl,es,pt-br,fr
...
var pathToImages = '_class/calendar/images/';	// Relative to your HTML file
...
switch(languageCode){
	...
	case "ro":	/* Romana */
		...
		var monthArrayShort = ['Jan','Feb','Mar','Apr','Mai','Iun','Iul','Aug','Sep','Oct','Noi','Dec'];
		var dayArray = ['Lu','Ma','Mi','Jo','Vi','Sa','Du'];
		var weekString = 'Sapt';
		var todayString = '';
	break;
	case "ge":	/* German */
