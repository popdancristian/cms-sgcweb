...
$o_dbgrid = new DbGrid(array('page'=>$page,'name'=>'frmManage','title'=>_l('manage'),'action'=>'','id'=>'domainid'));
$o_dbgrid->SetAttribute($attributes);
$o_dbgrid->SetSqlCount('select count(*) as nr from '.DB_PREFIX.'domain d');
$o_dbgrid->SetSql('select * from '.DB_PREFIX.'domain d');
...
(
   array
   ( 
    array('type'=>'text','field'=>'domainid','caption'=>_l('id'),'th'=>array('align'=>'center','style'=>'width:60px;')),
    array('type'=>'text','field'=>'name','caption'=>_l('name'),'ordon'=>'name','th'=>array('align'=>'center','style'=>'width:70%;')),
    array('type'=>'checkbox','field'=>'cache','caption'=>_l('cache'),'ordon'=>'cache','align'=>'center','action'=>'cache',
    ...
    array('type'=>'link','name'=>_l('files'),'action'=>'files','align'=>'center',
