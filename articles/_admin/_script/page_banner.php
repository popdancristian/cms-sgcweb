...
$o_dbgrid = new DbGrid(array('page'=>$page,'name'=>'frmManage','title'=>_l('manage'),'action'=>'','id'=>'bannerid'));
$o_dbgrid->SetAttribute($attributes);
$o_dbgrid->SetSqlCount('select count(*) as nr from '.DB_PREFIX.'banner where domainid = '.$_SESSION['domainid']);
$o_dbgrid->SetSql('select * from '.DB_PREFIX.'banner where domainid = '.$_SESSION['domainid']);
...
(
   array
   ( 
    array('type'=>'text','field'=>'image','caption'=>_l('image'),'ordon'=>'image','th'=>array('align'=>'center','style'=>'width:35%;')),
    array('type'=>'text','field'=>'position','caption'=>_l('position'),'ordon'=>'total','th'=>array('align'=>'center','style'=>'width:100px;')),
    array('type'=>'text','field'=>'url','caption'=>_l('url'),'ordon'=>'total','th'=>array('align'=>'center','style'=>'width:200px;')),
