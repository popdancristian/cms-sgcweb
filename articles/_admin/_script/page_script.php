...
$o_dbgrid = new DbGrid(array('page'=>$page,'name'=>'frmManage','title'=>_l('manage'),'action'=>'','id'=>'scriptid'));
$o_dbgrid->SetAttribute($attributes);
$o_dbgrid->SetSqlCount('select count(*) as nr from '.DB_PREFIX.'script s where domainid = '.$_SESSION['domainid']);
$o_dbgrid->SetSql('select * from '.DB_PREFIX.'script s where domainid = '.$_SESSION['domainid']);
...
(
   array
   ( 
    array('type'=>'text','field'=>'scriptid','caption'=>_l('id'),'ordon'=>'scriptid','th'=>array('align'=>'center','style'=>'width:60px;')),
    array('type'=>'text','field'=>'name','caption'=>_l('name'),'ordon'=>'title','th'=>array('align'=>'center','style'=>'width:50%;')),
    array('type'=>'text','field'=>'position','caption'=>_l('position'),'ordon'=>'total','th'=>array('align'=>'center','style'=>'width:60px;')),
